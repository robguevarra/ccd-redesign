...
export interface Image {
  ...
  /**
   * Base64-encoded LQIP (low-quality image placeholder), typically a tiny
   * blurred WebP. Inlined into the page HTML so the user sees something
   * immediately while Next.js's image loader generates the full variant.
   * Avoids the empty-container flash on cold-cache navigation.
   *
